  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < drops.length; i++) {
        ...
        ctx.fillStyle = `rgba(184, 243, 74, ${alpha})`;
    ...
    <main className="min-h-screen">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden scan-overlay">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.89 0.21 118 / 0.05) 0%, transparent 70%)",
          }}
        />

        <div className="relative z-10 flex flex-col items-center text-center px-4 fade-in-up">
          <div className="mb-6 inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border border-lime/30">
            <Zap className="h-3.5 w-3.5 text-lime" />
            <span className="text-xs font-semibold text-lime tracking-widest uppercase">
          ...
          >
            <span
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.94 0.015 250) 0%, oklch(0.89 0.21 118) 50%, oklch(0.73 0.16 162) 100%)",
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link to="/url-scanner" data-ocid="hero.primary_button">
              <Button
                size="lg"
                className="bg-lime text-navy-900 hover:bg-lime/90 font-bold px-8 h-12 glow-lime transition-all duration-200 hover:scale-105"
              >
            ...
            <Link to="/dns-whois" data-ocid="hero.secondary_button">
              <Button
                size="lg"
                variant="outline"
                className="border-teal/50 text-teal hover:bg-teal/10 font-bold px-8 h-12 transition-all duration-200 hover:scale-105"
              >
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-xs font-semibold text-lime tracking-widest uppercase mb-3">
              Capabilities
            </p>
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground">
              Everything you need to{" "}
              <span style={{ color: "oklch(0.89 0.21 118)" }}>stay secure</span>
            </h2>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-6 stagger">
            {features.map((feat) => {
              ...
              return (
                ...
                >
                  <div className="glass rounded-2xl p-7 h-full card-hover cursor-pointer">
                    <div
        ...
        <div className="max-w-3xl mx-auto">
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 80px oklch(0.89 0.21 118 / 0.08) inset",
            }}
          >
            <Activity className="h-12 w-12 text-lime mx-auto mb-5" />
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link to="/url-scanner" data-ocid="cta.primary_button">
                <Button className="bg-lime text-navy-900 hover:bg-lime/90 font-bold px-8 glow-lime">
